...
public class CompetitionDesignsClientTest extends TestBase {
	...
	public void DesignsTest() throws InterruptedException, AWTException, IOException {
		competitionDetailsDesignerClientPage = new CompetitionDetailsDesignerPage(driver);
		competitionDetailsDesignerClientPage.openDesignsFun();
		Assert.assertTrue(competitionDetailsDesignerClientPage.rateDes.isDisplayed());
