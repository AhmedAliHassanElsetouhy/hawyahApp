...
public class UpdateLoginDataClientTest extends TestBase {
	...
	public void updateLoginDataTest() throws IOException {
		...
		aboutMeClientPage = new AboutMeClientPage(driver);
		ExcelReader ER = new ExcelReader();
		myPageClientPage.openLoginDataFormPage();
		aboutMeClientPage.updateLoginDataForm(ER.getExcelData(1, 2)[1][1], ER.getExcelData(1, 2)[2][1],
