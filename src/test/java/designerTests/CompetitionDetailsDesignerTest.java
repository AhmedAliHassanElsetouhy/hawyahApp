...
public class CompetitionDetailsDesignerTest extends TestBase {
	...
	public void detailsTest() throws InterruptedException, AWTException, IOException {
		...
		Assert.assertTrue(competitionDetailsDesignerPage.catDes.isDisplayed());
		Assert.assertTrue(competitionDetailsDesignerPage.descDes.isDisplayed());
		Assert.assertTrue(competitionDetailsDesignerPage.ideaDes.isDisplayed());
	}
